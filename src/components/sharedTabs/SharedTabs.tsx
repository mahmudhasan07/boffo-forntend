                ...
                <div className="grid grid-flow-col auto-cols-max items-center justify-start">
                    {tabItems.map(({ value, label }) => (
                        <TabsTrigger
                            key={value}
                            value={value}
                            className="flex text-nowrap items-center justify-center gap-2 text-black hover:text-primary border-b border-transparent data-[state=active]:text-primary data-[state=active]:border-primary pb-2 lg:pb-3"
                        >
